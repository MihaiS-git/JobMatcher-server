...
public interface IPaymentService {
    Page<PaymentSummaryDTO> getAllPaymentsByCustomerId(UUID customerId, Pageable pageable);
    Page<PaymentSummaryDTO> getAllPaymentsByFreelancerId(UUID freelancerId, Pageable pageable);
